---
title: "[NestJS] nodemailer로 이메일 인증 구현하기"
date: 2023-08-31
tags:
- NestJS
description: Nest.js와 nodemailer로 이메일 인증을 구현하는 방법을 정리한 포스트입니다.
---
...
앱 비밀번호를 발급받는 방법은 [이곳](https://support.google.com/accounts/answer/185833?hl=ko)에서 확인할 수 있습니다. (저는 gmail을 사용했습니다.)
...
![Imgur](https://imgur.com/ZaVJ6Ca.png)
...
![Imgur](https://imgur.com/ifM1EiG.png)
...
인증을 실제로 한다면
생성된 인증번호를 DB나 세션에 저장해두어 유저가 입력한 인증번호와 비교하여 인증 성공/인증 실패 를 나눕니다.