...
<figcaption align="center">https://docs.nestjs.com/websockets/gateways</figcaption>
...
![](/images/9.23/9.23.image2.png)

`handleConnection` 메소드가 정상적으로 실행된 것을 로그로 확인할 수 있습니다.
![](/images/9.23/9.23.image3.png)
...
![](/images/9.23/9.23.image5.png)
수신할 이벤트를 `ServerToClient`로 설정하고
![](/images/9.23/9.23.image6.png)

메세지를 보내면 클라이언트의 메세지가 서버 로그에 남고
![](/images/9.23/9.23.image7.png)

클라이언트는 `server.emit`로 인해 서버로부터 메세지를 받습니다.
![](/images/9.23/9.23.image8.png)